...
const EFFETS_MERVEILLES = {
  ...
  vorlan_chancellery: "IA seulement : chaque tour, une chance sur cinq d'intégrer la plus faible de ses IA voisines (jamais une Cité commerçante)",
  ...
  thyr_conclave: "IA seulement : chaque tour, une chance sur dix d'intégrer la plus faible de ses IA voisines (jamais une Cité commerçante), et aucune révolte, révolution ni trahison ne l'atteint. Inutile à qui tient déjà la Chancellerie de Vorlan",
