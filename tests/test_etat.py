...
EXPECTED_GAME_KEYS = {
    ...
    "cultural_capture_counts", "ruin_territory_ids",
    "university_territory_ids",
    ...
    "wonder_territories", "apocalypse_site_stages", "apocalypse_site_owners",
    "eternal_ally_player", "eternal_ally_patron",
    "victory_milestones",
